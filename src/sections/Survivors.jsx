  ...
  const cat = [
    {
      ...
      img: "https://res.cloudinary.com/greenmouse-tech/image/upload/v1722614121/Rectangle_20025_cmhzgp.png",
      description:
          ...
          <div className="py-12">
            ...
            <div>
              <Slider ref={setSliderRef} {...survivorSettings}>
                {cat.map((item, i) => (
                  <div onClick={() => navigate("/bookagent")} key={i} className=" relative   !mr-4 rounded-[15px]  duration-100 cursor-pointer  w-full "> 
                    <p className="absolute bg-white px-3 py-1 rounded-[6rem] top-4 left-4 ">
                      Survivor Mentor
                    </p>
                    <img
                      src="https://res.cloudinary.com/greenmouse-tech/image/upload/v1722614121/Rectangle_20025_cmhzgp.png"
                      alt="icons"
                    ...
                    <p>
                      Medical practitioner, Healthcave Hospital. Fibroid
                      Survivor
                    </p>
                  </div>
                ))}
